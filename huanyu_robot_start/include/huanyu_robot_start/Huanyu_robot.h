...
class Huanyu_start_object : public rclcpp::Node
{
	public:
		Huanyu_start_object();
		~Huanyu_start_object();
	...
	private:
		...
		string odom_frame_id, imu_frame_id;
 	...
 	// 	dynamic_reconfigure::Server<huanyu_robot_start::pidConfig> server;
		...
		rclcpp::Publisher<sensor_msgs::msg::Imu>::SharedPtr imu_pub_raw;
		rclcpp::Publisher<std_msgs::msg::Float32>::SharedPtr power_pub;
		rclcpp::Publisher<std_msgs::msg::Float32MultiArray>::SharedPtr moto_pub;
        ...
        std_msgs::msg::Float32MultiArray MotoStr;
